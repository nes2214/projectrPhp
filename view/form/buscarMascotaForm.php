<div class="flex flex-col justify-center items-center w-full min-h-[200px] p-6">
    <div class="w-full max-w-md overflow-hidden rounded-xl border border-gray-800 shadow-2xl bg-gray-200">
        ...
        <div class="bg-gray-800 p-4">
            <h2 class="text-xl font-bold text-white-300 text-center uppercase tracking-wider">Buscar Mascotes per
                Propietari</h2>
        </div>

        <form method="get" action="" class="p-6 text-black">
            <fieldset class="space-y-4">
                <legend class="sr-only">Formulari de cerca per propietari</legend>
                ...
                <div>
                    ...
                    <input type="number" placeholder="Introdueix l'ID del propietari" name="propietari_id"
